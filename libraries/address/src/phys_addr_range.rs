...
impl_range!(PhysAddrRange, PhysAddr,
...
mod phys_range_tests {
    ...
    fn test_phys_range_page_operations() {
        ...
        let range = PhysAddrRange::new(unaligned_start, unaligned_end);
    ...
    fn test_phys_range_memory_operations() {
        ...
        let dram_range = PhysAddrRange::new(PhysAddr::new(0x80000000), PhysAddr::new(0x100000000));
    ...
    fn test_phys_range_merge_adjacent_pages() {
        let page1 = PhysAddrRange::new(PhysAddr::new(0x1000), PhysAddr::new(0x2000));
        let page2 = PhysAddrRange::new(PhysAddr::new(0x2000), PhysAddr::new(0x3000));
        let page3 = PhysAddrRange::new(PhysAddr::new(0x3000), PhysAddr::new(0x4000));
    ...
    fn test_phys_range_intersection() {
        let range1 = PhysAddrRange::new(PhysAddr::new(0x1000), PhysAddr::new(0x3000));
        let range2 = PhysAddrRange::new(PhysAddr::new(0x2000), PhysAddr::new(0x4000));
    ...
    fn test_phys_range_large_addresses() {
        ...
        let high_range = PhysAddrRange::new(
    ...
    fn test_phys_range_empty_and_edge_cases() {
        ...
        let empty_range = PhysAddrRange::new(addr, addr);
        ...
        // Test minimum range
        let min_range = PhysAddrRange::new(PhysAddr::new(0x1000), PhysAddr::new(0x1001));
